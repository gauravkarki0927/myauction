                                    ...
                                    <div className="w-full md:w-1/4 mb-6 md:mb-0">
                                        ...
                                        <div className="px-4 py-2">
                                            <div>
                                                ...
                                                <div
                                                    className="w-full border-gray-300 px-2 py-1 rounded border border-gray-50 text-gray-700 text-[14px] overflow-x-auto">
                                                    {user.user_email}
                                            ...
                                            <div>
                                                ...
                                                <div
                                                    className="w-full border-gray-300 px-2 py-1 rounded border border-gray-50 text-gray-500 text-[13px]"
                                                >Can't be shown...</div>
                                            </div>
                                        </div>
                                    </div>
